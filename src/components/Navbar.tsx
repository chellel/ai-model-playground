        ...
        <div className="flex items-center gap-10">
          ...
          <nav className="hidden md:flex items-center gap-8 text-sm font-medium text-gray-600">
            ...
            <button
              ...
              className="hover:text-purple-600 transition flex items-center gap-1 font-bold text-gray-800"
            >
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="relative">
            ...
            >
              ...
              <span className="text-xs font-bold text-purple-600">管理后台控制台</span>
              <ChevronDown className="w-3 h-3 text-gray-400" />
            </button>
            ...
            {userDropdownOpen && (
              <div className="absolute right-0 top-full mt-2 w-48 bg-white border border-gray-100 rounded-xl shadow-xl z-50 py-1.5 text-xs">
                <button
                  ...
                  className="w-full text-left px-3.5 py-2 hover:bg-gray-50 flex items-center gap-2 text-gray-700 font-bold"
                >
